...
public class AlertService(WeatherDbContext dbContext, ILogger<AlertService> logger) : IAlertService
{
    ...
    private static AlertSubscriptionResponse MapToSubscriptionResponse(AlertSubscriptionEntity entity, string city)
    {
